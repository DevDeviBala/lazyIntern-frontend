              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-circle-check-big h-5 w-5 text-green-600 mt-0.5"
                  >
              ...
              <div className="flex flex-col space-y-1.5 p-6">
                <h3 className="text-2xl font-semibold leading-none tracking-tight flex items-center gap-2">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-zap h-6 w-6 text-purple-600"
                  >
          ...
          <div className="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
            <div className="p-6">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-trending-up h-12 w-12 text-blue-600 mx-auto mb-4"
              >
          ...
          <div className="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
            <div className="p-6">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-building h-12 w-12 text-purple-600 mx-auto mb-4"
              >
          ...
          <div className="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
            <div className="p-6">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-circle-check-big h-12 w-12 text-green-600 mx-auto mb-4"
              >
                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                <path d="m9 11 3 3L22 4"></path>
              </svg>
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
              <div className="flex flex-col space-y-1.5 p-6">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-building h-12 w-12 text-blue-600 mx-auto mb-4"
                >
                  <rect width="16" height="20" x="4" y="2" rx="2" ry="2"></rect>
                  <path d="M9 22v-4h6v4"></path>
                  <path d="M8 6h.01"></path>
              ...
              <div className="p-6 pt-0">
                <p className="text-gray-600">
                  Find versatile engineers who can wear multiple hats and
                  contribute to your product from day one.
                </p>
              </div>
            </div>
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
              <div className="flex flex-col space-y-1.5 p-6">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-trending-up h-12 w-12 text-teal-600 mx-auto mb-4"
                >
                  <polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline>
                  <polyline points="16 7 22 7 22 13"></polyline>
                </svg>
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm text-center">
              <div className="flex flex-col space-y-1.5 p-6">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-users h-12 w-12 text-purple-600 mx-auto mb-4"
                >
                  <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
                  <circle cx="9" cy="7" r="4"></circle>
                  <path d="M22 21v-2a4 4 0 0 0-3-3.87"></path>
