                ...
                <div className="flex flex-col space-y-1.5 p-6 pt-8">
                  <h3 className="text-2xl font-semibold leading-none tracking-tight flex items-center gap-2">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-code h-6 w-6 text-teal-600"
                    >
                ...
                <div className="flex flex-col space-y-1.5 p-6 pt-8">
                  <h3 className="text-2xl font-semibold leading-none tracking-tight flex items-center gap-2">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-star h-6 w-6 text-purple-600"
                    >
            ...
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-2">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-briefcase h-8 w-8 text-teal-600"
                >
